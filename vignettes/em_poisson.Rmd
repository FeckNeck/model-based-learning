...
Generate a data set with 3 columns of 200 observation of Poisson-distributed values with
...
### "RealWorld dataset" Bag of Words

the data set is a bag of words of 20 words and 100 documents. Each
document is represented by a vector of 20 integers. Each integer
represents the number of times the word appears in the document.

```{r}
data = read.csv("../bag_of_words.txt",sep = ",", header = TRUE)
res2 <- em_poisson(data, 5)
```
The issue with this data set is that the log-likelihood function
converges to 0 because the values of the *tk* matrix are so low for 
a number of clusters greater than 2.
